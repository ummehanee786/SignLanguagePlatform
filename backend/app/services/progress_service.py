...
# --- Module-level singleton, so every router/service shares the same ---
# --- in-memory attempt log instead of each constructing its own       ---
# --- (independent, out-of-sync) instance.                              ---
